                        ...
                        <div class="row">
                                ...
                                <div class="card-box widget-user">
                                    <div>
                                        <div class="avatar-lg float-left mr-3">
                                            <img src="<?php echo base_url('assets/images/users/user-3.jpg');?>" class="img-fluid rounded-circle" alt="user">
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div>
                                        <div class="avatar-lg float-left mr-3">
                                            <img src="<?php echo base_url('assets/images/users/user-2.jpg');?>" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="wid-u-info">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div>
                                        <div class="avatar-lg float-left mr-3">
                                            <img src="<?php echo base_url('assets/images/users/user-1.jpg');?>" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="wid-u-info">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div>
                                        <div class="avatar-lg float-left mr-3">
                                            <img src="<?php echo base_url('assets/images/users/user-10.jpg');?>" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="wid-u-info">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="inbox-widget">
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="<?php echo base_url('assets/images/users/user-1.jpg');?>" class="rounded-circle" alt=""></div>
